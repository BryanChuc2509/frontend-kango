...
const VistaPrincipal: React.FC = () => {
  return (
    <div className="container-fluid p-0"> {/* Asegurar que no haya padding */}
      ...
      <section className="bg-success p-4 text-white text-center mb-4">
        <div className="row g-3">
          ...
          <div className="col-md-3">
            <label className="d-block text-start text-white mb-2">Punto de partida</label>
          ...
          {/* Fecha de salida */}
          <div className="col-md-3">
            <label className="d-block text-start text-white mb-2">Fecha de salida</label>
            <div className="input-group">
              <input
                type="date"
      ...
      <section className="row p-4">
        <div className="col-12">
          <h2 className="text-success fw-bold text-center mb-4">Reserva y Disfruta</h2> {/* Título agregado */}
        </div>
        <div className="col-md-4">
          <div className="image-container">
            <img src="/img/Chichen-Itza.jpg" alt="Destino 1" className="img-fluid rounded shadow" />
          </div>
        </div>
        <div className="col-md-4">
          <div className="image-container">
            <img src="/img/cenote.jpg" alt="Destino 2" className="img-fluid rounded shadow" />
          </div>
        </div>
        <div className="col-md-4">
          <div className="image-container">
            <img src="/img/rivera.jpg" alt="Destino 3" className="img-fluid rounded shadow" />
          </div>
        </div>
      </section>
        ...
        <section className="lo-mas-pedido">
          ...
          <div className="contenedor-tarjetas">
            ...
            <div className="tarjeta">
              <img src="/img/camioneta.jpg" alt="Camioneta Vans Mercedes" className="tarjeta-imagen" />
            ...
            {/* Tarjeta 2 */}
            <div className="tarjeta">
              <img src="/img/nissan.jpg" alt="Urvan Nissan" className="tarjeta-imagen" />
              <div className="tarjeta-contenido">
                <h3>Urvan Nissan</h3>
      ...
      <div className="container mt-5">
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-md-5 mx-2 border border-success rounded p-3">
            ...
            <p className="fw-bold">Cancún, Quintana Roo</p>
            <p className="text-muted">
              Explore el Parque Xel-Ha, el impresionante acuario natural de la Riviera Maya, en este viaje de un día desde Cancún. Relájese en la playa oculta de Xel Ha, nade en cenotes y lagunas, practique snorkel y diviértase en cuevas.
            </p>
          </div>
        </div>
      </div>
